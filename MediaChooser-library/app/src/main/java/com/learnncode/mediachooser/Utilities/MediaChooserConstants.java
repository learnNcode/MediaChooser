...
public class MediaChooserConstants {
	...
	public static final String BRAODCAST_IMAGE_RECEIVER = "BROADCAST_FOR_IMAGE_BUCKET";
	public static final String BRAODCAST_VIDEO_RECEIVER = "BROADCAST_FOR_VIDEO_BUCKET";
